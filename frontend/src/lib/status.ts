...
export const STATUS: Record<StatusKey, StatusStyle> = {
  ...
  pending_advisor: { label: '申請待審核', fg: '#8A5A00', bg: '#FFF3D6' },
  pending_chief: { label: '申請待審核', fg: '#8A5A00', bg: '#FFF3D6' },
  pending_dean: { label: '申請待審核', fg: '#8A5A00', bg: '#FFF3D6' },
  approved: { label: '已核准', fg: '#1F6B45', bg: '#E3F2E9', border: 'rgba(31,107,69,.4)' },
  closing_pending_advisor: { label: '結案待審核', fg: '#8A5A00', bg: '#FFF3D6' },
