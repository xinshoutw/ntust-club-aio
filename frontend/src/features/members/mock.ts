...
export const MEMBERS: Member[] = [
  { id: 1, name: '顏志明', studentId: 'B11200001', kind: '社長／會長', title: '會長', semester: '114-2', updatedAt: '2026/06/01 09:12' },
  { id: 2, name: '林小芳', studentId: 'B11200002', kind: '副社長／副會長', title: '副會長', semester: '114-2', updatedAt: '2026/06/01 09:12' },
