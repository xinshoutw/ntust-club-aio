...
- **D-14 會讓遷移件的評鑑分數往上跳**:779 筆已結案的遷移活動裡,724 筆的照片確認、687 筆的報告表確認、
  675 筆的心得確認都是 true(來自舊系統),而新庫裡一個照片檔與心得列都沒有。改判定前這些一律 0 分,
  改後照舊系統的紀錄計分。學年末真的跑評鑑前,承辦要知道這批分數的來源是舊系統的旗標
