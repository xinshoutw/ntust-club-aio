...
**基本資料卡** — 性質、帳號(停用時標紅)、網頁連結、簡介、聯絡 Email,以及**對外公開資料**(唯讀):頭像與橫幅縮圖、一句話介紹、標籤、招生狀態、對外聯絡信箱、社群連結、社辦位置、例行活動時間、入社方式、報名連結、成立年份、公開顯示狀態。全空時只顯示一句「尚未填寫對外公開資料」。

公開顯示開關在[管理項目](club-settings.md),本頁只看得到目前是開是關。

**進行中申請**(左)— 活動申請與空間報修混列,點活動開審核彈窗(與申請審核頁同版面,待審者可直接核准/退回;「⋯」選單可刪除活動,D-39),點報修開唯讀詳情(含佐證照片/影片連結)。彈窗詳情失敗由**彈窗自己**顯示(見 [review.md](review.md)),不報在這張卡上 —— 那則錯誤與卡片列出的清單無關。
