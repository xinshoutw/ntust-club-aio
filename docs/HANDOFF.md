...
7. **A3 進行中(2026-08-11)**:已完成 52 項(ISS-17 + 十個子批次共 51 項),其餘 16 項(新增 ISS-96)見下方 A3 清單
...
**A3 其餘 16 項**(可上線後補,全部不需任何人決策 —— 新 session 直接從這裡挑一批開始,作業流程見 `AGENTS.md`「修 issues.md 的條目時」)
