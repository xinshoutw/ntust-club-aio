...
| **繳交確認的預設勾選** | 從一律全勾改為「已落庫的旗標**且**內容達採計門檻」(ad2 照片 5 張或影片、ad3 報告表這一列存在、ad4 心得有上傳;門檻是後端計不計分那條,不是送件下限)。核准是唯一寫得到這三欄的地方、寫完即 `closed`,全勾等於承辦沒動它就把遷移件的「未繳」翻成「已繳」;遷移件靠承辦自行勾回補上。詳情端點一併帶出三個旗標 |
