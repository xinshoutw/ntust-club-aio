...
| **繳交確認的預設勾選** | 從一律全勾改為「已落庫的旗標**且**內容達門檻」(照片 5 張或影片、報告表這一列存在、心得達送出下限 3 篇)。承辦核准是唯一由人填這三欄的地方(社團重送結案會整份取代 report、旗標回到預設 true),寫完即 `closed`。旗標是 AND 閘:遷移件沒搬照片與心得,那兩項勾回去也不會加分。詳情端點一併帶出三個旗標;手上這份不確定是最新的就不給核准 |
