...
export const REVIEW_ITEMS: ReviewItem[] = [
  ...
  { id: 'ACT-114-0031', club: '機器人研究社', name: '機器人組裝工作坊', type: '社課或會議', date: '2026/09/28', requested: 6000, status: 'pending_advisor' },
  ...
  { id: 'ACT-114-0029', club: '學生會', name: '校慶園遊會攤位審查說明會', type: '社課或會議', date: '2026/09/30', requested: 0, status: 'rejected' },
]
